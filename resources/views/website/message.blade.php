            ...
            <div class="row">
                <div class="col-12">
                    <div class="subheader-content">
                        <h1 class="page-title text-white fw-600">Message From Chirman</h1>
                        <ul class="custom-flex breadcrumb">
                            <li><a href="/">Home</a></li>
                            <li>Chirman Message</li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-8">
                    <div class="post-details mb-md-80">
                        ...
                        <blockquote class="bg-orange">
                            ...
                            <h3 class="fw-600 text-blue">{{ $message->caption }}"</h3>
                        </blockquote>
                        <p class="fw-500 mb-xl-10">{{ $message->short_content }}"</p>

                        <figure class="image-alignment left">
                            <img src="{{ $message->banner_image }}" class="image-fit" alt="">
                        </figure>
                        <p class="fw-500 mb-xl-10">{{ $message->long_content }}"</p>
                    </div>
                </div>
